...
public interface RecursoMapper {
    ...
    /**
     * agregar a la base de datos un nuevo recurso para su disposicion futura
     * @param rec recurso nuevo para agregar
     */
    public void agregarRecurso(@Param("recurso") Recurso rec);
    
    /**
     * consultar en la base de datos el recurso asociado
    ...
    /**
     * consultar en la base de datos todos los recursos con los que dispone la universidad
